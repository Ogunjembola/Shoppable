...
class UserProfileActivity : BaseActivity(),View.OnClickListener {
    ...
    private fun setupActionBar() {
        val toolbarr: Toolbar =findViewById(R.id.toolbar_user_profile_activity)
    ...
    override fun onClick(v: View?) {
        if (v != null) {
            when (v.id) {
                ...
                // TODO Step 4: Add the click event to the SAVE button.
                // START
                R.id.btn_save -> {
    ...
    fun userProfileUpdateSuccess() {
        ...
        startActivity(Intent(this@UserProfileActivity, DashActivity::class.java))
        finish()
    }
