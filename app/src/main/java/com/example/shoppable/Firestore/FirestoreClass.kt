package com.example.shoppable.Firestore
...
import com.example.shoppable.models.*
import com.example.shoppable.ui.fragments.ProductsFragment
import com.example.shoppable.ui.activities.*
import com.example.shoppable.ui.fragments.DashboardFragment
import com.example.shoppable.ui.fragments.OrdersFragment
import com.example.shoppable.ui.fragments.SoldProductsFragment
            ...
            .addOnSuccessListener { document ->
                ...
                val sharedPreferences =
                    activity.getSharedPreferences(
                        Constants.SHOPPABLE_PREFERENCES,
            ...
            .addOnSuccessListener { taskSnapshot ->
                ...
                taskSnapshot.metadata!!.reference!!.downloadUrl
                    .addOnSuccessListener { uri ->
                        ...
                        when (activity) {
                            is UserProfileActivity -> {
                                activity.imageUploadSuccces(uri.toString())
                            }
